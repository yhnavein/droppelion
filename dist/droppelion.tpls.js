angular.module('droppelion').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('templates/droppelion.html',
    ...
    "    <input type=\"text\" autocomplete=\"off\" id=\"{{controlId}}\" class=\"form-control\" ng-model=\"itemName\" placeholder=\"{{prompt}}\" ng-focus=\"focused = true\" ng-change=\"changedSearch()\" ng-disabled=\"selected\" tabindex=\"{{customIndex}}\" />\n" +
